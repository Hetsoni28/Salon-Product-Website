...
const MOCK_PRODUCTS = [
  {
    ...
    howToUse: 'Heat wax to 130ï¿½F. Cleanse skin with Pre-Wax Cleansing Gel. Apply wax in the direction of hair growth. Allow to cool for 10-15 seconds. Pull firmly in the opposite direction of hair growth.',
